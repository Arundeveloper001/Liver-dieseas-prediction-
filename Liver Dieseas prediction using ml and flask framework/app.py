...
def predict(values, dic):
    ...
    # liver disease 
        ...
        model = pickle.load(open(r'D:\Arun\liver dieseas prediction using ml and flask framework\Liver Dieseas prediction using ml and flask framework/liver.pkl','rb'))
